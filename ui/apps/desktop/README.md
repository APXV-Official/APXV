...
v1.3.0 ships **Windows MSI/NSIS** and **Linux deb/AppImage**. macOS DMG is planned for a follow-up release (build requires a Mac).
...
- `ui\apps\desktop\src-tauri\target\release\bundle\msi\APXV_1.3.0_x64_en-US.msi`
- `ui\apps\desktop\src-tauri\target\release\bundle\nsis\APXV_1.3.0_x64-setup.exe`
