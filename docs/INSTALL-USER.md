...
5. Paste or confirm your operator API key on the setup screen.
...
- **Quit** — stops API and exits

Same features as the browser UI: Dashboard, Pipeline, Jobs, Artifacts, Verify, Audit, Governance, Agent packs, Settings.
...
| Port 8741 in use | Quit other APXV/Docker instances |
