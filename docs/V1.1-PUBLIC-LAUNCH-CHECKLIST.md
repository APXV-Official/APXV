...
**Release tag:** `v1.1.0` — shipped 2026-06-22.
...
- [x] Export verifier bundle (VKs + manifests only, no PKs):
  ...
  ```
- [x] Third party can verify attestation with bundle + `verify_attestation --real-zk`
...
- [x] v1.1 narrative: [DEMO-SCRIPT-V1.1.md](DEMO-SCRIPT-V1.1.md) (canonical live demo; v1.0 video retained for text/E2EE)
...
- [x] Tag `v1.1.0` and GitHub Release with verifier bundle artifact
...
| Engineering | [x] |
| Security review | [x] |
| Demo / narrative | [x] (script + v1.0 video labeled) |
| Public launch | [x] |