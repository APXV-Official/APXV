...
- Transcript published alongside releases (GitHub Release asset or `docs/assets/` for reference deployments).
...
- Collaborative MPC setup; toxic waste destroyed by protocol.
