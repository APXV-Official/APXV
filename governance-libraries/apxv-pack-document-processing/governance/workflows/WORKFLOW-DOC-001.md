# APXV1 — Workflow DOC: Batch Document Processing & Attestation

**Workflow ID:** APX-WF-DOC-001  
**Version:** 0.1.0  
**Effective Date:** 2026-06-28  
**Depends On:** APX-RULE-DOC-001  
...
2. For each file: load governance specs, hash input, apply redactions per APX-RULE-DOC-001.
...
6. Coordinate attestation via APX-AGENT-003.
