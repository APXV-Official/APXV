"""
APX v1 — Script 1: run_apx.py (Main Orchestrator)

This is the primary end-to-end runner for the APX v1 tiny implementation.

It executes the complete 3-agent pipeline:
    RuleGovernedRedactor (Agent 1)
        → WorkflowOrchestrator (Agent 2)
        → AttestationCoordinator (Agent 3)
...
def run_full_pipeline(
    ...
    *,
    ...
    # === Agent 1: Redaction ===
    print("\n[1/3] Running RuleGovernedRedactor (APX-AGENT-001)...")
    ...
    print("\n[2/3] Running WorkflowOrchestrator (APX-AGENT-002)...")
    ...
    print("\n[3/3] Running AttestationCoordinator (APX-AGENT-003)...")
...
def main():
    ...
    if with_proof:
        ...
        # Generate proofs in dependency order: redaction → rule-binding → pipeline
