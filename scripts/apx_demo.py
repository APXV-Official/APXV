"""
APXV1 pack demo — pack pipeline, attest, verify, print artifact path.

For instances already initialized (setup_first_run complete).

    python -m scripts.apx_demo
    python -m scripts.apx_demo --pack document
    python -m scripts.apx_demo --pack ai
    python -m scripts.apx_demo --pack all
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="APXV1 pack demo — pack pipeline, attest, verify, artifact path"
    )
    parser.add_argument(
        "--pack",
    ...
    print("  API:      python -m scripts.apx_serve")
